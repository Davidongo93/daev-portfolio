...
CREATE INDEX "comment_slug_idx" ON "comment" USING btree ("post_slug");--> statement-breakpoint
CREATE INDEX "comment_parent_idx" ON "comment" USING btree ("parent_id");--> statement-breakpoint
CREATE UNIQUE INDEX "reaction_unique_idx" ON "reaction" USING btree ("user_id","target_type","target_id","emoji");--> statement-breakpoint
CREATE INDEX "reaction_target_idx" ON "reaction" USING btree ("target_type","target_id");