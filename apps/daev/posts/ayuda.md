...
## 1. Contrátame para hacer tu sitio web

Es la forma que más me sirve, porque no es un favor: es trabajo. Diseño y desarrollo sitios web completos —landing pages, sitios corporativos, catálogos, blogs, tiendas— con buen rendimiento, posicionamiento en buscadores y todo lo necesario para que el sitio quede en línea y funcionando.
...
**→ [Ver planes y precios en daev.space/pricing](https://daev.space/pricing)**
...
Estamos abriendo la **preventa** de la primera producción:
...
- **Precio:** **$32.000 COP**.
- **Versiones:** natural · con raíz de osha · con menta.
- **Cómo reservar:** [WhatsApp](https://wa.me/573015740156) o **+57 301 574 0156**.
...
1. **Entra a [unamanito.online](https://www.unamanito.online/)** y regístrate con tu **número de teléfono** y tu **correo electrónico**. No necesitas más.
2. **Carga saldo** en tu billetera de la plataforma. El saldo se carga transfiriéndome el dinero a mis cuentas (Bre-B, Daviplata o Nequi — los datos están en la sección **Cómo pagar**, más abajo) y subiendo el comprobante en la aplicación.
...
**El segundo puesto es el número invertido.** Si el primer puesto es el 1234, el segundo puesto es el 4321. De ahí sale el detalle bonito: si eliges un **número palíndromo** —uno que se lee igual al derecho y al revés, como el 1221 o el 44—, tu número compite por los dos puestos y tienes el doble de posibilidades.

**El sorteo lo define quien más apoya.** Cuando se venden todos los stickers de una actividad, la persona que más stickers compró elige cómo se realiza el sorteo: con la aplicación o con una lotería de Colombia que ella misma escoja, y también elige la fecha.
