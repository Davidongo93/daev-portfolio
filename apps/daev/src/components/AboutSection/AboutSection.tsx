...
const AboutSection: React.FC = () => {
  return (
    <section
      id="about"
      className="text-white bg-black opacity-95 items-center justify-center"
      style={{ minHeight: 'calc(100vh - 4rem)' }}
    >
      <div className="w-screen flex flex-col md:flex-row-reverse  p-4 max-w-screen-lg mx-auto">
