export const siteConfig = {
  ...
  experience: [
    ...
    },
    {
      ...
      description: {
        en: 'Websites, stores and platforms for my own clients, from the first call to their domain: Chez Boaz Tours, Ópticas Apolo Visión, Climb Rock, Chilcuague, ArteSano Market and more.',
        es: 'Sitios, tiendas y plataformas para clientes propios, de la primera llamada a su dominio: Chez Boaz Tours, Ópticas Apolo Visión, Climb Rock, Chilcuague, ArteSano Market y otros.',
      },
      website: null,
    },
    {
  ...
  // ── Casos de cliente ────────────────────────────────────────────
  // El home vende resultados, no tecnologías. Cada caso responde: qué estaba
  // roto, qué construí y qué cambió. `metrics` sólo lleva números medidos de
  // verdad — nunca estimaciones; los casos sin medición usan `highlights`.
  caseStudies: [
    {
      ...
      problem: {
        en: 'Their WordPress site took almost 8 seconds to load on mobile, had broken buttons and sections that never rendered, and could not take a single payment online.',
        es: 'Su sitio en WordPress tardaba casi 8 segundos en cargar en móvil, tenía botones rotos y secciones que no cargaban, y no podía cobrar un solo peso en línea.',
      },
      work: {
        en: 'I rebuilt it from scratch as a static Astro site on Cloudflare Workers: 2026 tour catalogue, cart, checkout with a 30% deposit through Bold, and TravelAgency structured data.',
        es: 'Lo reconstruí desde cero como sitio estático en Astro sobre Cloudflare Workers: catálogo de tours 2026, carrito, checkout con anticipo del 30 % por Bold y datos estructurados de agencia de viajes.',
      },
      metrics: [
        { value: '1,62 s', from: '7,90 s', label: { en: 'Mobile LCP', es: 'LCP en móvil' } },
        { value: '499 KB', from: '3,1 MB', label: { en: 'Page weight', es: 'Peso de la página' } },
        { value: '211 ms', from: '2.905 ms', label: { en: 'Blocking time', es: 'Tiempo de bloqueo' } },
        { value: '15', from: '102', label: { en: 'Requests', es: 'Peticiones' } },
      ],
      highlights: [],
      technologies: ['Astro', 'TypeScript', 'Cloudflare Workers', 'D1', 'Bold'],
    ...
    },
    {
      ...
      problem: {
        en: 'A fall-protection engineering company that manufactures its own hardware had no website at all: every quote request arrived through Facebook or word of mouth.',
        es: 'Una empresa de ingeniería de protección contra caídas que fabrica su propio herraje no tenía sitio web: cada solicitud de cotización llegaba por Facebook o por voz a voz.',
      },
      work: {
        en: 'A server-rendered Astro site on Cloudflare Workers covering their six service lines, with real project photography, the Resolution 4272 of 2021 compliance story and one-tap WhatsApp quoting.',
        es: 'Un sitio Astro renderizado en el servidor sobre Cloudflare Workers con sus seis líneas de servicio, fotografía real de obra, el respaldo normativo de la Resolución 4272 de 2021 y cotización por WhatsApp en un toque.',
      },
      metrics: [],
      highlights: [
        { en: 'Six service lines published with their own landing content', es: 'Seis líneas de servicio publicadas con contenido propio' },
        { en: 'Quote request in a single tap, with context pre-filled', es: 'Cotización en un solo toque, con el contexto precargado' },
        { en: 'Rendered at the edge on Cloudflare Workers', es: 'Renderizado en el borde sobre Cloudflare Workers' },
        { en: 'ProfessionalService structured data for local search', es: 'Datos estructurados ProfessionalService para búsqueda local' },
      ],
      technologies: ['Astro', 'SSR', 'Cloudflare Workers', 'Supabase', 'TypeScript'],
    ...
    },
    {
      ...
      problem: {
        en: 'An optician with two branches and fifteen years of customers could only sell in person — there was no way to browse frames or book an eye exam online.',
        es: 'Una óptica con dos sedes y quince años de clientes sólo podía vender en el mostrador: no había forma de ver monturas ni agendar un examen visual en línea.',
      },
      work: {
        en: 'A custom e-commerce store with a searchable catalogue of sunglasses, frames, lenses and drops, cart and checkout, nationwide shipping and online eye-exam booking.',
        es: 'Una tienda e-commerce a medida con catálogo buscable de gafas, monturas, lentes y gotas, carrito y checkout, envío a todo el país y agendamiento del examen visual en línea.',
      },
      metrics: [],
      highlights: [
        { en: 'Full catalogue online with search and wishlist', es: 'Catálogo completo en línea con búsqueda y favoritos' },
        { en: 'Checkout with nationwide shipping', es: 'Checkout con envío a todo el país' },
        { en: 'Eye-exam booking for both branches', es: 'Agendamiento del examen visual para las dos sedes' },
      ],
    ...
    },
    {
      ...
      product: null,
      summary: {
        en: 'Store and back office for a natural-extracts brand selling in Ecuador and Colombia.',
        es: 'Tienda y panel de gestión para una marca de extractos naturales que vende en Ecuador y Colombia.',
      },
      sector: {
        en: 'Natural products · Ecuador & Colombia',
        es: 'Productos naturales · Ecuador y Colombia',
      },
      problem: {
        en: 'A small maker of golden-root extracts sold through Instagram, WhatsApp and partner shops, with production costs, consignment stock and sales per shop tracked by hand.',
        es: 'Un pequeño productor de extractos de raíz de oro vendía por Instagram, WhatsApp y tiendas aliadas, y llevaba a mano los costos de producción, el stock en consignación y las ventas de cada tienda.',
      },
      work: {
        en: 'A bilingual, two-country store with prices in USD and COP, an interactive body map of traditional and studied uses, and an admin covering inventory, production batches with their costs, consignment per partner shop and sales analytics.',
        es: 'Una tienda bilingüe en dos países con precios en USD y COP, un mapa corporal interactivo de usos tradicionales y estudiados, y un panel con inventario, lotes de producción con sus costos, consignación por tienda aliada y analítica de ventas.',
      },
      metrics: [],
      highlights: [
        { en: 'Two countries and two languages from a single store', es: 'Dos países y dos idiomas desde una sola tienda' },
        { en: 'Production batches costed and transferred to inventory', es: 'Lotes de producción con costo y traslado a inventario' },
        { en: 'Consignment stock and sales tracked per partner shop', es: 'Stock en consignación y ventas por tienda aliada' },
        { en: 'Interactive body map with each use labelled by its evidence', es: 'Mapa corporal interactivo con cada uso etiquetado según su evidencia' },
      ],
      technologies: ['Astro', 'SSR', 'Cloudflare Workers', 'Supabase', 'Cloudinary', 'TypeScript'],
      liveUrl: 'https://chilcuague.site',
      repoUrl: null,
      thumbnail: '/thumbnails/chilcuague.webp',
      gallery: ['/work/chilcuague/1.webp', '/work/chilcuague/2.webp', '/work/chilcuague/3.webp'],
      year: '2026',
      role: { en: 'Design & full stack', es: 'Diseño y full stack' },
    },
    {
      slug: 'artesano-market',
      name: 'ArteSano Market',
      product: null,
      summary: {
        en: 'Online store, till and consignment back office for a community market in Ayampe.',
        es: 'Tienda en línea, caja y control de consignación para un mercado comunitario en Ayampe.',
      },
      sector: {
        en: 'Community market · Ayampe, Ecuador',
        es: 'Mercado comunitario · Ayampe, Ecuador',
      },
      problem: {
        en: 'A market that sells what its neighbours make, on consignment, had to work out every month by hand what each maker had sold, what stock was left and how much they were owed.',
        es: 'Un mercado que vende en consignación lo que hacen sus vecinos tenía que calcular a mano, cada mes, cuánto vendió cada emprendedor, qué stock quedaba y cuánto había que pagarle.',
      },
      work: {
        en: 'A bilingual store with a showcase for every maker, plus a back office with a till for in-store sales, web orders that only touch stock once confirmed, and a monthly close per maker that reconciles the count and settles the commission.',
        es: 'Una tienda bilingüe con vitrina para cada emprendedor, y un panel con caja para la venta en el local, pedidos web que solo tocan el stock al confirmarse y un cierre de mes por emprendedor que cuadra el conteo y liquida la comisión.',
      },
      metrics: [],
      highlights: [
        { en: 'In-store till and web orders on the same stock', es: 'Caja del local y pedidos web sobre el mismo stock' },
        { en: 'Monthly close per maker: count, adjustment and payout', es: 'Cierre de mes por emprendedor: conteo, ajuste y liquidación' },
        { en: 'Commission per maker, overridable per product', es: 'Comisión por emprendedor, ajustable por producto' },
        { en: 'Brand manual, vector logo and palette delivered with the site', es: 'Manual de marca, logo vectorizado y paleta entregados con el sitio' },
      ],
      technologies: ['Astro', 'SSR', 'Cloudflare Workers', 'Supabase', 'Cloudinary', 'TypeScript'],
      liveUrl: 'https://artesanomarket.domirandar.workers.dev',
      repoUrl: null,
      thumbnail: '/thumbnails/artesano.webp',
      gallery: ['/work/artesano-market/1.webp', '/work/artesano-market/2.webp', '/work/artesano-market/3.webp'],
      year: '2026',
      role: { en: 'Brand, design & full stack', es: 'Marca, diseño y full stack' },
    },
    {
      ...
      problem: {
        en: 'Regulated cannabis cultivation has to prove the traceability of every plant, and the operation was tracking it on spreadsheets that no audit would accept.',
      ...
      metrics: [],
      highlights: [
        { en: 'Plant-to-batch traceability built for audit', es: 'Trazabilidad de planta a lote pensada para auditoría' },
        { en: 'Role-based access across the operation', es: 'Acceso por roles en toda la operación' },
        { en: 'Containerised API with documented endpoints', es: 'API contenerizada con endpoints documentados' },
      ],
      technologies: ['Next.js', 'NestJS', 'PostgreSQL', 'Docker', 'TypeScript'],
      // El dominio está en migración: no se publica un enlace que no resuelve.
    ...
    },
    {
      ...
      problem: {
        en: 'A firefighter and vertical-rescue instructor with fifteen years in the field had his whole portfolio scattered across social media, with nowhere to send a prospective client.',
        es: 'Un bombero e instructor de rescate vertical con quince años de campo tenía todo su portafolio disperso en redes sociales, sin un lugar propio a donde mandar a un cliente.',
      },
      work: {
        en: 'A personal site with a Cloudinary-backed photo gallery of real operations, his service lines and direct contact through every channel he already used.',
        es: 'Un sitio personal con galería fotográfica en Cloudinary de operaciones reales, sus líneas de servicio y contacto directo por todos los canales que ya usaba.',
      },
      metrics: [],
      highlights: [
        { en: 'Optimised photo gallery served from Cloudinary', es: 'Galería fotográfica optimizada servida desde Cloudinary' },
        { en: 'Every social channel funnelled into one contact point', es: 'Todos los canales sociales concentrados en un punto de contacto' },
      ],
  ...
  // ── Lab: retos técnicos y proyectos propios ─────────────────────
  // Van debajo de los casos y con menor jerarquía a propósito: prueban oficio,
  // no resultados de negocio.
  labProjects: [
    {
      name: 'Ukraine Population & Roads Map',
      description: {
        en: 'Interactive map of Ukraine population density and road infrastructure from GeoJSON data.',
        es: 'Mapa interactivo de densidad poblacional e infraestructura vial de Ucrania a partir de datos GeoJSON.',
      },
      repoUrl: 'https://github.com/Davidongo93/pop-ukraine-map',
      liveUrl: 'https://pop-ukraine-map.vercel.app/',
      technologies: ['Next.js', 'TypeScript', 'Leaflet', 'GeoJSON'],
      type: { en: 'Tech Challenge', es: 'Reto Técnico' },
      thumbnail: '/thumbnails/ukraine.webp',
    },
    {
      name: 'GitPulse — Repo Comparison Tool',
      description: {
        en: 'Web app to visualise and compare GitHub repositories with graphs.',
    ...
    },
    {
      ...
      description: {
        en: 'Backend-oriented full stack challenge with NestJS, JWT auth and PostgreSQL.',
    ...
    },
    {
      name: 'PI Videogames',
      description: {
        en: 'Full stack videogame catalogue with filtering, sorting and detail pages.',
